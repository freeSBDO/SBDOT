...
% Kriging
krig1 = Kriging ( prob1 , 1 , [], 'corr', 'corrgauss', 'estim_hyp', @marginalLikelihood);
krig2 = Kriging ( prob1 , 1 , [], 'corr', 'corrgauss', 'estim_hyp', @pseudoLikelihood );

krig3 = Kriging ( prob2 , 1 , [], 'corr', 'corrgauss', 'estim_hyp', @marginalLikelihood);
krig4 = Kriging ( prob2 , 1 , [], 'corr', 'corrgauss', 'estim_hyp', @pseudoLikelihood );
...
line([krig1.lb_hyp_corr krig1.lb_hyp_corr],[-10 60],'Color','r')
line([log10(krig1.hyp_corr0) log10(krig1.hyp_corr0)],[-10 60],'Color','g')
line([krig1.ub_hyp_corr krig1.ub_hyp_corr],[-10 60],'Color','r')
...
line([krig1.lb_hyp_corr krig1.lb_hyp_corr],[-140 40],'Color','r')
line([log10(krig1.hyp_corr0) log10(krig1.hyp_corr0)],[-140 40],'Color','g')
line([krig1.ub_hyp_corr krig1.ub_hyp_corr],[-140 40],'Color','r')
plot( hp , loo_val_7, 'k-')
legend({'Bornes d''optimisation','Point inital'},...
    'Interpreter','latex','Location','southwest')
hold off
...
xlabel('$\log(\theta)$','interpreter','latex')
ylabel('Fonction de vraisemblance r\''{e}duite','interpreter','latex') 
line([krig3.lb_hyp_corr krig3.lb_hyp_corr],[-140 40],'Color','r')
line([log10(krig3.hyp_corr0) log10(krig3.hyp_corr0)],[-140 40],'Color','g')
line([krig3.ub_hyp_corr krig3.ub_hyp_corr],[-140 40],'Color','r')
...
xlabel('$\log(\theta)$','interpreter','latex')
ylabel('Leave-one-out','interpreter','latex')
line([krig3.lb_hyp_corr krig3.lb_hyp_corr],[-250 50],'Color','r')
line([log10(krig3.hyp_corr0) log10(krig3.hyp_corr0)],[-250 50],'Color','g')
line([krig3.ub_hyp_corr krig3.ub_hyp_corr],[-250 50],'Color','r')
