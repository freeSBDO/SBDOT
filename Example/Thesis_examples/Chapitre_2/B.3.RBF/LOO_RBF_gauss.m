...
% Kriging
rbf1 = RBF ( prob1 , 1 , [], 'corr', 'Corrgauss', 'estimator', 'LOO');
rbf2 = RBF ( prob2 , 1 , [], 'corr', 'Corrgauss', 'estimator', 'LOO' );
...
line([rbf1.lb_hyp_corr rbf1.lb_hyp_corr],[3 9],'Color','r')
line([rbf1.hyp_corr0 rbf1.hyp_corr0],[3 9],'Color','g')
line([rbf1.ub_hyp_corr rbf1.ub_hyp_corr],[3 9],'Color','r')
...
xlabel('$\log(\theta)$','interpreter','latex')
ylabel('Leave-one-out (\''echelle log)','interpreter','latex') 
line([rbf2.lb_hyp_corr rbf2.lb_hyp_corr],[-20 10],'Color','r')
line([rbf2.hyp_corr0 rbf2.hyp_corr0],[-20 10],'Color','g')
line([rbf2.ub_hyp_corr rbf2.ub_hyp_corr],[-20 10],'Color','r')
