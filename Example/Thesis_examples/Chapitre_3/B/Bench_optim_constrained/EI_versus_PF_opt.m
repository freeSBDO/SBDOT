...
for i = 1 : 20
    ...
    obj = Expected_improvement(prob, 1, 1, @Kriging, 'fcall_max', 50);
    ...
    fcall_result(i,:) = obj.fcall_num;
        ...
        title('EI versus PF','interpreter','latex')
        axis([-2 2 -2 2])
        box on
...
save('EI_versus_PF_result','RMSE_result_y','RMSE_result_g','failure','x_min_result','y_min_result','fcall_result')
