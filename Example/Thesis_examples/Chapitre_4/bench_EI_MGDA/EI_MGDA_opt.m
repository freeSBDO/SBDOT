...
for i = 1 : 20
    ...
    % Lancement de l'optimisation par critère EI_MGDA
    EGO = Multi_obj_EI_MGDA( prob, [1 2], [], @Kriging, 5, ...
        'fcall_max',40);
...
save('EI_MGDA_results','spread_meas','spacing_meas','hyp_meas','nbr_pareto','min_y')
