...
function [regressionFcn, expression, terms] = regressionFunction( this, varargin )
    ...
    %% optional: the expression and individual terms corresponding to the degrees matrix
    % not supported
    if nargout > 1
        error( 'CoKriging:regressionFunction: Symbolic expression not supported for co-kriging' );
    end
end
