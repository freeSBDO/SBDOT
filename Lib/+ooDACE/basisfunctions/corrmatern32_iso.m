...
%> Signature
%>	[corr, dx, dhp, rho] = corrmatern32_iso(hp, d)
%
% ======================================================================
...
%>   with nud = 2.*nu
% ======================================================================
function [corr, dx, dhp, rho] = corrmatern32_iso(hp, d)
...
if nargout > 1
    ...
    dtx = sqrt(nud) .* d .* ell(ones(n,1),ones(1,m)) ./ dist(:,ones(1,m));
